...
/*-------------------------- Torneo: CRobots (2015) ------------------------
  ...
  CROBOT:    corbu15.r         (macro)
  CATEGORIA: 2000 istruzioni     (macro)
  AUTORE:    Andrea Jasci Cimini
  
  Code utilization: 96%   (1929 / 2000)
  corbu15.r compiled without errors
...
-----------------------------------------------------------------------------
  ...
  CORBU 15
   ...
   At the beginning of the robot checks whether it is a single battle,
