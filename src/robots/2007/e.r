...
Riparametrizzazione di Enigma, ritoccato qua e la'                                           */
...
while(1)
{
while(loc_y()>150) zz(220,350);
 while(loc_y()<850) zz(140,10);
} 
}
...
look(par)
{if (!(dist=scan(par,10))) if (!(dist=scan(par+20,10))) dist=900;}
