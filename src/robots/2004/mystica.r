/*
Nome: 	mystica.r	(classic)
Autore: 	Franco Cartieri

Torneo 2004

Mystica.r e' un crobots che deriva da Magneto.r.
...
int a, oa, r, or, i, t, h, rng, deg, odeg, i, f2f, nc;

main()
{
	s_lim=(ang_pref=180*((dy=(loc_y(nc=f2f=0)>500)*960+20)>500)+90*((dx=(loc_x()>500)*960+20)!=dy))+110;
    	while(f2f==0)
      {
