/*
BJT.r
Macro robot per il torneo 2004
...
L'attacco deriva da yerba.r e aladino.r
*/
...
main()
{
    ...
    /*se siamo 4 contro 4, per prima cosa rompo le scatole al primo avversario*/
    seek(att=damage()+20);
        ...
        while((damage(spara(drive(dir,100)))<att)&&orng) {
                if(t%2) {
                        if (loc_x()>910 ) dir=180;
                                ...
                                else if(orng<500) dir=deg+40+(b^=1)*235;
