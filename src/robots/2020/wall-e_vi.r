...
Wall-E VI inherits (almost) everything from Wall-E V because its author is
lazy and does not have much time.
...
Wall-E VI should improve its fire efficiency.
...
*/
int ang,        /* Current scan degree                                  */
    oang,       /* Previous scan degree                                 */
    range,
    dir,        /* Heading                                              */
    posx,
    posy,       /* Bit variables holding the current position           */
    flag,b,     /* Status flags                                         */
    timer,      /* Timer and enemies counter                            */
    deg,        /* Starting degree to scan and count enemies            */
    i,tmp;          /* Temporary variables                                  */
...
{
    dir=270-180*posy;
    while( (loc_y()%880) > 120) fire(dir,100);
    fire(dir,0);
}
...
main()
{
    ...
    while (1)
    {
        ...
        while(timer<2)
        {
            ...
            else if (range>610) dir=ang+15+330*(b^=1);
