/*
  ...
  Code utilization: 99%   (1984 / 2000)
  C:\crobots\_test\Mac\ma_43x0802.r compiled without errors
...
/* -------------------------------------------------- */
dx() {while(loc_x()<925) firev(0,  100); fire0(0,  0);}
up() {while(loc_y()<925) firev(90, 100); fire0(90, 0);}
sx() {while(loc_x()>75 ) firev(180,100); fire0(180,0);}
dn() {while(loc_y()>75 ) firev(270,100); fire0(270,0);}
/* -------------------------------------------------- */
...
int d,v;
   ...
   if((r=scan(oa=a,10))&&(r<832))
   {
      ...
      else
      {
         ...
         {
            if (scan(a,1)) return(cannon(a+(a-oa),2*scan(a,10)-r));
            else
            {
         ...
         if ((++ne)>1)
         {
            ...
            while(++c)
            {
               ...
               if (loc_x(t=9)<500)
               {
                  ...
                  while(--t)
                  {
                     while(loc_x()<=dd) firevs(d1,100); firev(d2,59);
