...
SCHEDA TECNICA:
  ...
  Con il poco tempo a disposizione ho provato a fare qualche ritocco all'ottimo 
  robot minion di Franco Cartieri! Ho modificato il puntamento della routine di 
  fuoco, l'angolo di oscillazione e la temporizzazione dell'attacco.
