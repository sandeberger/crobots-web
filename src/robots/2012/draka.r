...
SCHEDA TECNICA:
  ...
  Nel macro ho inserito una nuova routine di attacco contemporaneo a 3 avversari. 
  La routine e' pensata per contrastare i robot molto difensivi che si nascondono in prossimita' degli angoli:
  il robot si posiziona in prossimità del centro, ma sempre nel proprio quadrante di gioco; quindi attacca i tre 
  avversari con oscillazioni orizzontale, verticale e lungo la bisettrice dell'angolo opposto; controlla 
  inoltre che il proprio angolo non sia stato occupato da un avversario che cambia angolo, in caso lo attacca,
  sempre oscillando.  
  Il tutto e' incastrato nelle tattiche e negli attacchi simili a quelli dei due midi.
