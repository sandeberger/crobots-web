/*************************************************************************/
/**   NOME ROBOT: R. DANEEL Olivaw   ** R_DANEEL si posiziona sul       **/
/**   DATA      : 01 - 09 - 1993     ** margine sinistro  del campo di  **/
...
main()
{
	drive(180,100);   /* posizionamento iniziale */
	while(loc_x() > 20) fuoco();
