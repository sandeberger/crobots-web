...
ulteriormente se r2>r1, e diminuirlo in caso contrario. In aggiunta
rispetto a Tabori 1, Tabori 2 effettua un aggiustamento anche
sull'angolo, anche se non in tutte le situazioni questo artificio si
dimostra efficiente. Infine il robot copia le variabili a2 ed r2 in
a1 ed r1, in modo tale da poter individuare nuovamente il  nemico
alla successiva esecuzione di kill().
\******* **** *** ** * *  *   *      *      *   *  * * * ** *** **** *******/
