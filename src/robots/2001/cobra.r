...
Molto simile a Rudy_xp, ma piu'offensivo, rende al meglio contro robot
piu'scarsi di quelli preferiti da rudy_xp.
Diciamo che Cobra sta a Rudy_xp come Zombie a Rudolf_6. 
Come quasi tutti i crobot piu' recenti Cobra comincia l'incontro
raggiungendo l'angolo piu'vicino (spostandosi prima verticalmente e poi
orizzontalmente). Qui il motore e' lo stesso di Zombie, con ovvie
semplificazioni:
...
-L'oscillazione e' parallela ad un lato e la scelta della direzione
 ...
 La lunghezza delle oscillazioni e' 250 metri SEMPRE.
...
E' una versione magra di Zombie, e allo stesso tempo e' il cugino kamikaze di
Rudy_xp.
...
int b,xa,ya,flag,flag1,nas,dri,oor,over,dver,danni,dor,daa,mm,ang,dr,do,aq,rng,t,dir,oldr,deg,odeg,dist,yora,xora;
         ...
         if (t>4)
              {
               flag=90*b-30;
               flag1=2;
               while (flag1&&flag<362) flag1-=(scan(flag+=20,10)>0);
               t=10002*((flag1>0));
              }
}
sx(550);
