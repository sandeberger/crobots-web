...
/* fare,soltanto che un giorno...


/* TOM:-UŠ, Ale, che cosa stai sfrazzando con quel computer ? -    */
/* ALE:-Beh, sto facendo un nuovo robot per il torneo !            */
/*      Non te ne sarai anche quest' anno dimenticato spero ? -    */
/* TOM:-Ma guarda te, la pigrizia fa fare proprio brutti scherzi.- */
/* ALE:-PerchŠ non fai vibrare GevBass2 ?                     -    */
/* TOM:-OK !
/*                              ...e cos nacque Titania.          */
/*                                                                 */
/* (Finto) Programmatore:                                          */
/*                       Tommaso De Pra                            */
