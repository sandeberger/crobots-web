...
Enigma e' una versione ristretta di Rudolf_7, conseguentemente rientra
nella categoria dei classicbots da 1000 istruzioni, perdendo tuttavia una
buona dose della sua efficienza a causa della liposuzione

Premessa:

Gli anni scorsi nel momento in cui si poneva il problema di iniziare il
nuovo robot ho sempre avuto la tendenza ad ispirarmi (copiare!!!) le idee
...
l'efficacia gia' dimostrata nei test preliminari proprio dal presente
Enigma, che poi ha dato lo spunto per i due big del gruppo, Zorn e Rudolf_7.


Strategia:

Come quasi tutti i crobot piu' recenti e furbi Enigma comincia l'incontro
...
Questa distanza aumenta nel finale se Enigma non ha troppi danni, in modo
da evitare pareggi inutili.
Quando vede un solo avversario lo attacca con una routine molto simile a
quella del suo predecessore Rudolf_6.
...
di partenza e' stato anche qui Fizban. Rispetto alla routine di Zorn e Rudolf e'
temporizzata peggio per ovvi motivi di spazio :-(
...
4) L'attacco e' stato migliorato essenzialmente perche' e' stata rifatta la
routine di sparo, simile a quella usata nel corso del match

5) non ci sono le toxiche, ma questa non e' una grande novita', a maggior
ragione in un robot sotto le 1000 istruzioni


Commenti:

Enigma e' un robot abbastanza "estremo", nel senso che si basa su un
