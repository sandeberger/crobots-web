...
+ --------------------------------------------------------------------------- +
 ...
 CANCER resta nell'angolo iniziale finche' non viene colpito con una certa
 frequenza o finche' qualcuno si avvicina piu' di 300 m. Se gli angoli adiacenti
 ...
 CANCER utilizza anche una variabile q che indica il numero del quadrante
...
{
    dir=ang (x,y);
    while (dist(x,y)>28500) {drive (dir,100); fuoco(0);}
...
/* parte da -10 per ovviare al bug dell'angolo zero */
numEnemy ()
{
    i=-10; ne=0;
    while (i<360) {
