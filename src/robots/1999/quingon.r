/* 
	...
	Quin-Gon-jin cavaliere Jedi e maestro si Obi-wan-Kenobi 

*/



/*quin_gon_jin differisce da obiwan solamente che quando i danni 
sono > 50% cambia tipo di oscillazione senza alternarle tra loro */
