...
SCHEDA TECNICA:
Cyborg si porta inizialmente a destra o a sinistra a seconda di dove nasce
...
Cyborg lo attacca oscillando dx-sx al centro dell' arena.

COMMENTO:
Lo spostamento da un angolo all' altro e' tale da permettere a Cyborg di
...
degli avversari.
Cyborg controlla prima gli angoli di destra per le note questioni riguardanti
il bug di scansione.
