...
xfmin()  { sk=1;spara(drive(deg=dir=360,100)); if(t>1000&&damage()<40) fuoco(drive(360,100));spara(drive(360,100));sk=0;stop(360);} 
xfmag()  { sk=1;spara(drive(deg=dir=180,100)); if(t>1000&&damage()<40) fuoco(drive(180,100));spara(drive(180,100));sk=0;stop(180);}
yfmag()  { sk=1;spara(drive(deg=dir=270,100)); if(t>1000&&damage()<40) fuoco(drive(270,100));spara(drive(270,100));sk=0;stop(270);} 
yfmin()  { sk=1;spara(drive(deg=dir=90,100)); if(t>1000&&damage()<40) fuoco(drive(90,100));spara(drive(90,100));sk=0;stop(90);}
