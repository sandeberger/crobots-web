...
SCHEDA TECNICA:
  ...
  Le differenze rispetto a Elminster sono la FASE 3 e quindi anche il f2f e una
  FASE 1 un po' piu' lunga.
...
FASE 1:  
  ...
  Controlli per decidere se passare alla fase successiva:
    ...
    1) Dopo 260 oscillazioni si passa comunque alla fase 2;
...
FASE 3:
  ...
  La routine offensiva della fase 3 e' molto semplice: fino al 50% di danno esegue un
  quadrato minimo al centro dell'arena, dopo il 50% di danni il quadrato si allarga
  di 200 unita' in tutte le direzioni e l'oscillazione e' quindi molto lunga. 
    
  Questa routine rende un po' meno nei test del 2k2, ma credo che sia piu' adatta
  per il nuovo torneo soprattutto come FASE 3 del 4vs4.
