/*  PatCioca CRobot   Roma 31/08/94  */

/*  Scorre l' arena secondo una traiettoria verticale 
    lungo il margine destro della arena fermandosi agli angoli.
    La routine di fuoco e' ottimizzata sia rispetto
    alla gittata che rispetto all'angolo ed e' ricavata
    dal precedente robot Poirot.r.
...
fuocoright()  /* routine di fuoco durante le manovre */
{
  int range,ra;
