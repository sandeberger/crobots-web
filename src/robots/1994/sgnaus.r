...
main()
{
	...
	{
		if((Dir==90 && loc_y()>880) || (Dir==270 && loc_y()<120)
...
fuoco2()
{
	while (Range && Range<640)  /* Sparo dinamico */
	{
		Old_Ang=Ang; 
		Old_Range=Range; 
