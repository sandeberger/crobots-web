/*  == Didimo ==  di  Federico Macchi   29/09/1993
    ...
    Questo è il mio secondo robot, ed è lo stesso che ha partecipato lo 
    scorso anno, sfiorando l'accesso alla finale. Purtroppo non avevo 
    tenuto conto che i caratteri significativi per l'identificatore di 
    una funzione sono solo sette, così che il mio robot, che staziona in 
    due angoli differenti, era completamente imbelle in uno di questi.
*/

int danno, ang, new, old, d, x, y; /* new e old contengono la nuova e vecchia
                                      distanza del robot intercettato 
                                      d è il quadrato della distanza da n punto
