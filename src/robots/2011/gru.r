...
Descrizione robot:
Gru è semplicemente il mio robot Gantu dell'anno scorso con qualche parametro modificato, più un tentativo di cambio angolo nel caso di danni.
All'inizio dell'incontro Gru si posiziona nell'angolo più vicino e controlla se è un f2f in questo caso parte subito all'attacco.
Altrimenti inizia a muoversi lungo i lati dell'arena prima orizzontalmente poi verticalmente senza mai allontanarsi troppo dall'angolo.
Ogni 12 cicli controlla il numero di avversari, se ne è rimasto uno solo inizia l'attacco finale.
Se viene colpito cerca un angolo libero in cui spostarsi.
...
int b,x,y,dir,rngscan,rng,orng,deg,odeg,asin,acos;
int xs,ys,en,timer,xd,yd,xp,yp,dmax,dmin,zd,t,dam;
