...
Piperita.r del 05-gennaio-2011,
assemblato da Marco Borsari.

Scheda tecnica:
Il robot e' un lieve miglioramento di Macchia del 2010, la cui
descrizione originale e' disponibile in archivio. L'eliminazione di
una scan dalla funzione di fuoco ha permesso di spostare il controllo
sulla distanza utile in un punto in cui non disturba il mantenimento
del bersaglio nell'attacco a triangolo. Inoltre si e' anche reso
disponibile lo spazio per rendere Pip. piu' rognosa, se l'avversario
si avvicina troppo, tenuto conto del livello di danno, va a rubargli
l'angolino.
*/
